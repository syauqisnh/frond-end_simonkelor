      ...
      <CCardBody>
        ...
        <CCol sm={4} className="d-none d-md-block">
          <CRow>
            <CCol xs={5}>
          <h6>
          <CBadge className='rounded-circle text-danger' color="danger">.</CBadge> Realisasi 
          </h6></CCol>
            <CCol xs={5}>
          <h6>
          <CBadge className='rounded-circle text-info' color="info">.</CBadge> Prediksi
          </h6></CCol>
          </CRow>
        </CCol>
        </CRow>
      ...
      <CCol xs={6}>
            <CChartDoughnut
              data={{
                ...
                datasets: [
                  {
                    backgroundColor: ['#41B883', '#E46651', '#00D8FF', '#900B16'],
                    data: [40, 50, 30, 20],
                  },
                ],
              }}
...
<CCol xs={6}>
    <CCardBody>
        <CTable striped>
          <CTableHead>
            <CTableRow>
              <CTableHeaderCell scope="col">Pembangkit</CTableHeaderCell>
              <CTableHeaderCell scope="col">Bauran energi</CTableHeaderCell>
              <CTableHeaderCell scope="col">Beban</CTableHeaderCell>
          ...
          <CTableBody>
              ...
              <CTableRow>
                <CTableDataCell> PLTU PLN BOLOK 1 </CTableDataCell>
              ...
              <CTableRow>
                <CTableDataCell> PLTU PLN BOLOK 2 </CTableDataCell>
                <CTableDataCell> Batubara </CTableDataCell>
                <CTableDataCell> 14.81 </CTableDataCell>
                <CTableDataCell> 15.37 </CTableDataCell>
              </CTableRow>
