        ...
        <div className="panel-forum">
          <div className="panel-body">
            ...
            <div className="mar-top">
              ...
              <Button className="button-sub-forum" href="forum">
                Cancel
              </Button>
            </div>
          </div>
        ...
        <div className="be-comment">
          ...
          <div className="be-comment-content">
            ...
            <p className="be-comment-text">
              ...
              mattis, at maximus eros commodo. Cras magna nunc, cursus lobortis
              luctus at, sollicitudin vel neque. Duis eleifend lorem non ant.
              Proin ut ornare lectus, vel eleifend est. Fusce hendrerit dui in
