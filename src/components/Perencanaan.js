...
const Perencanaan = () => {
  ...
  const opsi = [
    {
      Dokumen: "Perencanaan PT PLN UPK Timor 2019",
      waktu: "Bulanan",
      tanggal: "19 Januari 2019",
      jenis: "PDF",
    },
    {
      Dokumen: "Perencanaan PT PLN UPK Timor 2020",
      waktu: "Harian",
      tanggal: "7 Desember 2020",
      jenis: "PDF",
    },
    {
      Dokumen: "Perencanaan PT PLN UPK Timor 2021",
      waktu: "Mingguan",
      tanggal: "16 Oktober 2021",
      jenis: "PDF",
    },
    {
      Dokumen: "Perencanaan PT PLN UPK Timor 2022",
      waktu: "Tahunan",
                          ...
                          if (user.role === "Super Admin") {
                            return (
                              <CTableDataCell style={{ cursor: "pointer" }}>
                                <BsIcons.BsPencilSquare title="Edit" className="delete-icon" />
